...
size_t TCMGetParamCount(const TCM* m); /*returns dim(\theta) of the model  m*/
...
/*TODO: makes more sense to put these in .cpp, not here, switch with TCMLogMeanComparisonOverTime*/
void TCMLogPerSpeciesMean(TCM* m, double T, double tStep, size_t sampleCount, FILE* logFile);
/*TODO: makes more sense to put these in .cpp, not here, switch with TCMLogStdComparisonOverTime*/
...
/*TODO: makes more sense to put these in .cpp, not here, switch with TCMLogFullDistributionComparisonOverTime*/
...
/*TODO: rare time embeddings staan nu gecomment, kun je niet makkelijk aanzetten of uitzetten*/
