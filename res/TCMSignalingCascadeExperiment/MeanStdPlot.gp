...
plot    'mean.data' index 1 using 1:2 w l lw 3 lc "red" title 'X1', \
        ...
        'mean.data' index 1 using 1:4 w l lw 3 lc "green" title 'X3', \
        'mean.data' index 1 using 1:5 w l lw 3 lc "yellow" title 'X4', \
        'mean.data' index 0 using 1:2 w l lw 5 dt "..." lc "red" notitle, \
        'mean.data' index 0 using 1:3 w l lw 5 dt "..." lc "blue" notitle, \
        'mean.data' index 0 using 1:4 w l lw 5 dt "..." lc "green" notitle, \
        'mean.data' index 0 using 1:5 w l lw 5 dt "..." lc "yellow" notitle, \
...
plot    'std.data' index 1 using 1:2 w l lw 3 lc "red" title 'X1', \
        ...
        'std.data' index 1 using 1:4 w l lw 3 lc "green" title 'X3', \
        'std.data' index 1 using 1:5 w l lw 3 lc "yellow" title 'X4', \
        'std.data' index 0 using 1:2 w l lw 5 dt "..." lc "red" notitle, \
        'std.data' index 0 using 1:3 w l lw 5 dt "..." lc "blue" notitle, \
        'std.data' index 0 using 1:4 w l lw 5 dt "..." lc "green" notitle, \
        'std.data' index 0 using 1:5 w l lw 5 dt "..." lc "yellow" notitle
